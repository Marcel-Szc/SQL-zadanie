...
<nav>
   ...
   <h3>
           ...
           <?php 
           $ile = $polaczenie->query("SELECT COUNT(ID) as ilerekordow FROM bazacsv WHERE WIEK BETWEEN 19 and 50;");
   ...
   <div class="osoby19_50">
       <?php 
       $zapytanie = $polaczenie->query("SELECT bazacsv.ID, bazacsv.IMIE, bazacsv.NAZWISKO, bazacsv.WIEK FROM bazacsv WHERE WIEK BETWEEN 19 and 50;");
       echo "<ul>";
