...
<body>
    ...
    <h3>
            ...
            <?php 
            $ile = $polaczenie->query("SELECT COUNT(ID) as ilerekordow FROM bazacsv;");
    ...
    <div class="all">
        <?php 
        $zapytanie = $polaczenie->query("SELECT bazacsv.ID, bazacsv.IMIE, bazacsv.NAZWISKO, bazacsv.WIEK FROM bazacsv");
        echo "<ul>";
